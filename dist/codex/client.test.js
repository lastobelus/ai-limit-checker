...
describe('CodexClient', () => {
    ...
    describe('getCredentials', () => {
        ...
        it('should throw error when auth.json missing', async () => {
            ...
            await expect(client.getCredentials()).rejects.toThrow('Not logged in');
        });
        it('should use CODEX_HOME environment variable', async () => {
            ...
            expect(fs.readFile).toHaveBeenCalledWith(expect.stringContaining('/custom/codex'), 'utf-8');
    ...
    describe('extractResetTimestamp', () => {
        it('should extract reset_at field', () => {
            ...
            const result = client.extractResetTimestamp(window);
    ...
    describe('normalizeTimestamp', () => {
        it('should convert milliseconds to seconds', () => {
            const result = client.normalizeTimestamp('1704384000000');
            expect(result).toBe(1704384000);
        });
        it('should keep seconds as is', () => {
            const result = client.normalizeTimestamp('1704384000');
            expect(result).toBe(1704384000);
        });
        it('should parse ISO string with Z', () => {
            const result = client.normalizeTimestamp('2024-01-04T16:00:00Z');
            expect(result).toBe(1704384000);
        });
        it('should strip fractional seconds', () => {
            const result = client.normalizeTimestamp('2024-01-04T16:00:00.123Z');
            expect(result).toBe(1704384000);
        });
        it('should return 0 for invalid timestamp', () => {
            const result = client.normalizeTimestamp('invalid');
